...
from global_helpers import dayHelper as dates
...
class tickerPortfolio:
    base_directory = 'C:/Users/tynan/code_work_personal/finance/data/'
    ...
    def __str__(self):
        return (
            ...
            f"  previous_days_data_available={'Yes' if self.previous_days_data else 'No'}\n"
            f")"
        )
